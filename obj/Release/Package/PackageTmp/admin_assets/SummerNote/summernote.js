  ...
  var Renderer = function () {
    ...
    tplToolbarInfo = {
      ...
      fontname: function(lang) {
        ...
        var sMarkup = '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="' + lang.font.name + '" tabindex="-1"><span class="note-current-fontname">MullerNarrow-Light</span> <b class="caret"></b></button>';
      ...
      fontsize: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="' + lang.font.size + '" tabindex="-1"><span class="note-current-fontsize">11</span> <b class="caret"></b></button>' +
               '<ul class="dropdown-menu">' +
                 ...
                 '<li><a data-event="fontSize" data-value="20"><i class="fa fa-check icon-ok"></i> 20</a></li>' +
                 '<li><a data-event="fontSize" data-value="22"><i class="fa fa-check icon-ok"></i> 22</a></li>' +
...
$('#summernote').summernote({
    fontSizes: ['8', '9', '10', '11', '12', '14', '18','20','22', '24', '36', '48', '64', '82', '150']
});